...
namespace MyRevit.MyTests.Template
{
    ...
    {
        public void Generate(Document doc, TemplateModel model, Element element)
        {
            Generate(doc, model, element, null);
        }
        public void Generate(Document doc, TemplateModel model, Element element, XYZ offset)
        {
        ...
        public void Regenerate(Document doc, TemplateModel model, Element target)
        {
            //FamilyInstance line = doc.GetElement(model.LineId) as FamilyInstance;
            //TemplateContext.Creator.Regenerate(doc, model, target, (line.Location as LocationPoint).Point - model.LineLocation);
        }
        public void Regenerate(Document doc, TemplateModel model, Element target, XYZ offset)
        {
        ...
        public void Clear(Document doc, TemplateModel model)
        {
            ////删除线
