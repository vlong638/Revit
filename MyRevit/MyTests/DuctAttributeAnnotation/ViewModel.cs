...
namespace MyRevit.MyTests.DAA
{
    ...
    public class DAAViewModel : VLViewModel<DAAModel, DAAWindow, DAAViewType>
    {
        public DAAViewModel(UIApplication app) : base(app)
        {
            ...
            //用以打开时更新页面
            AnnotationType = DAAAnnotationType.SPL;
            LocationType = DAALocationType.Center;
        }
        ...
        DAATextType TextType
        {
            ...
            set
            {
                ...
                RaisePropertyChanged("TextType_Middle");
                RaisePropertyChanged("TextType_Above");
            }
        }
        public bool TextType_Middle
        {
            get { return TextType == DAATextType.Middle; }
            set { if (value) TextType = DAATextType.Middle; }
        }
        public bool TextType_Above
        {
            get { return TextType == DAATextType.Above; }
            set { if (value) TextType = DAATextType.Above; }
        }
        #endregion
        ...
        public string SPLPreview { get { return string.Format("如:SF 400mmx400mm {0}2600", Model.AnnotationPrefix); } }
        public string SLPreview { get { return string.Format("如:SF {0}2600", Model.AnnotationPrefix); } }
        public string PLPreview { get { return string.Format("如:400mmx400mm {0}2600", Model.AnnotationPrefix); } }
        public string SPPreview { get { return string.Format("如:SF 400mmx400mm"); } }
        #endregion
        #endregion
