...
namespace MyRevit.MyTests.PipeAttributesAnnotation
{
    ...
    {
        public void Generate(Document doc, PAAModel model, Element element)
        {
            Generate(doc, model, element, null);
        }
        public void Generate(Document doc, PAAModel model, Element element, XYZ offset)
        {
        ...
        public void Regenerate(Document doc, PAAModel model, Element target)
        {
        ...
        public void Regenerate(Document doc, PAAModel model, Element target, XYZ offset)
        {
