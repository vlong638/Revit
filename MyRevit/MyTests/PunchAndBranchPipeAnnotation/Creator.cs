...
namespace MyRevit.MyTests.PBPA
{
    public class PBPACreator
    {
        ...
        public void Generate(Document doc, PBPAModel model, Element element, XYZ offset)
        {
        ...
        public void Regenerate(Document doc, PBPAModel model, Element target)
        {
            //FamilyInstance line = doc.GetElement(model.LineId) as FamilyInstance;
            //PBPAContext.Creator.Regenerate(doc, model, target, (line.Location as LocationPoint).Point - model.LineLocation);
        }
        public void Regenerate(Document doc, PBPAModel model, Element target, XYZ offset)
        {
        ...
        public void Clear(Document doc, PBPAModel model)
        {
            ////删除线
