...
namespace MyRevit.SubsidenceMonitor.Entities
{
    ...
    /// </summary>
    public class PressedPipeLineSubsidence : EIssueTypeEntity
    {
        public override EIssueType IssueType { get { return EIssueType.管线沉降_有压; } }
    ...
    public class PressedPipeLineSubsidenceDataV1 : ITNodeData
    {
        /// <summary>
        /// str需为this.ToString()的数据
        /// </summary>
        /// <param name="str"></param>
        public PressedPipeLineSubsidenceDataV1()
        {
        }
        public PressedPipeLineSubsidenceDataV1(string nodeCode, string str)
        {
            DeserializeFromString(nodeCode, str);
        }
        public PressedPipeLineSubsidenceDataV1(string nodeCode, string currentChanges, string sumChanges, string sumPeriodBuildingEnvelope, string sumBuildingEnvelope)
        {
            NodeCode = nodeCode;
    ...
    public class PressedPipeLineSubsidenceCollection<T>
        : ITNodeDataCollection<T>
        where T : PressedPipeLineSubsidenceDataV1, new()
    {
